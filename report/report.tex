...
\part{Appendices}
\appendix
\input{appendix_hookes_law}
\input{appendix_test_data}
\input{appendix_surface_model}
\input{appendix_test_machines}
\input{appendix_openengine}
%\clearpage
\cleardoublepage
\bibliography{refs}
