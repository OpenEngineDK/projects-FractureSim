...
\begin{figure}
  ...
  \subfloat[bar $20 \times 20 \times 20$.]{
    \includegraphics[width=7cm]{./images/results_bar_20.png}
    \label{fig:bar20}
  }
  \subfloat[bar $10 \times 10 \times 10$.]{
    \includegraphics[width=7cm]{./images/results_bar_10.png}
    \label{fig:bar10}
  }
  \newline
  \subfloat[bar $5 \times 5 \times 5$.]{
    \includegraphics[width=7cm]{./images/results_bar_5.png}
    \label{fig:bar5}
  }
  \subfloat[bar $2.5 \times 2.5 \times 2.5$.]{
    \includegraphics[width=7cm]{./images/results_bar_2_5.png}
    \label{fig:bar2-5}
  }
...
\begin{figure}
  ...
  \subfloat[Tooth from the front.]{
    \includegraphics[width=7cm]{./images/results_tooth_wf_front.png}
    \label{fig:tooth-front}
  }
  \subfloat[Tooth above.]{
    \includegraphics[width=8cm]{./images/results_tooth_wf_above.png}
...
\begin{figure}
  ...
  \subfloat[Tooth with 33\% slice.]{
    \includegraphics[width=5cm]{./images/results_tooth_wf_side.png}
    \label{fig:tooth-side}
  }
  \subfloat[Test tooth with 50\% slice.]{
    \includegraphics[width=4cm]{./images/results_test_tooth_wf.png}
    \label{fig:test-tooth-side}
  }

  \subfloat[Closeup of the drill hole in tooth with 33\% slice.]{
    \includegraphics[width=7cm]{./images/results_tooth_wf_closeup.png}
